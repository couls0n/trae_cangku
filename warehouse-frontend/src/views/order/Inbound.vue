  ...
  <div class="inbound-container">
    <el-card>
      ...
      <el-table :data="tableData" border stripe v-loading="loading">
        ...
        <el-table-column prop="orderTime" label="入库时间" width="180"></el-table-column>
    ...
    async loadData() {
      ...
      try {
        ...
        this.tableData = res.data.records.map(item => {
          ...
          const supplier = this.supplierList.find(s => s.id === item.supplierId)
          return {
            ...item,
